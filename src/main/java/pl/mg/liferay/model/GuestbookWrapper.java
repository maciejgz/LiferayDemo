...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
    ...
    */
    ...
    @Override
    public int compareTo(pl.mg.liferay.model.Guestbook guestbook) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<pl.mg.liferay.model.Guestbook> toCacheModel() {
        return _guestbook.toCacheModel();
    }

    @Override
    public pl.mg.liferay.model.Guestbook toEscapedModel() {
        return new GuestbookWrapper(_guestbook.toEscapedModel());
    }

    @Override
    public pl.mg.liferay.model.Guestbook toUnescapedModel() {
