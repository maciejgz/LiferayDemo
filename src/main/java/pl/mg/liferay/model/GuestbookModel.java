 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link pl.mg.liferay.model.impl.GuestbookModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link pl.mg.liferay.model.impl.GuestbookImpl}.
 * </p>
 *
 * @author maciek
 * @see Guestbook
...
public interface GuestbookModel extends BaseModel<Guestbook>, StagedGroupedModel,
    ...
    @Override
    public CacheModel<pl.mg.liferay.model.Guestbook> toCacheModel();
