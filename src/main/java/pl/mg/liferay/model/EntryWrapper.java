...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
    ...
    */
    ...
    @Override
    public int compareTo(pl.mg.liferay.model.Entry entry) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<pl.mg.liferay.model.Entry> toCacheModel() {
        return _entry.toCacheModel();
    }

    @Override
    public pl.mg.liferay.model.Entry toEscapedModel() {
        return new EntryWrapper(_entry.toEscapedModel());
    }

    @Override
    public pl.mg.liferay.model.Entry toUnescapedModel() {
