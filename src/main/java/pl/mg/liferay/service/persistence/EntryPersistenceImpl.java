...
import pl.mg.liferay.NoSuchEntryException;
import pl.mg.liferay.model.Entry;
import pl.mg.liferay.model.impl.EntryImpl;
import pl.mg.liferay.model.impl.EntryModelImpl;
import pl.mg.liferay.service.persistence.EntryPersistence;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
    ...
    @Override
    public Entry updateImpl(pl.mg.liferay.model.Entry entry)
        throws SystemException {
        entry = toUnwrappedModel(entry);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.pl.mg.liferay.model.Entry")));
